...
DROP POLICY IF EXISTS "Users can only access their own revision sets" ON revision_sets;
DROP POLICY IF EXISTS "Users can only access their own documents" ON documents;
DROP POLICY IF EXISTS "Users can only access their own summaries" ON document_summaries;
DROP POLICY IF EXISTS "Users can only access their own flashcards" ON document_flashcards;
